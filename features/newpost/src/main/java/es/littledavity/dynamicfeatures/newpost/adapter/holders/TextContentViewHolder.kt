...
import es.littledavity.dynamicfeatures.newpost.databinding.ListItemTextContentBinding
...
) : BaseViewHolder<ListItemTextContentBinding>(
    binding = ListItemTextContentBinding.inflate(inflater)
) {
